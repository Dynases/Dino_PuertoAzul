...
Public Class Pr_Ventas12Meses
    ...
    Public Sub _prIniciarTodo()
        ...
        cbCiudad.Enabled = IIf(swCiudad.Value = True, False, True)
    ...
    Private Sub _prCargarComboLibreria(mCombo As Janus.Windows.GridEX.EditControls.MultiColumnCombo, cod1 As String, cod2 As String)
        ...
        End With
    End Sub
    Sub _prCargarTableCLIENTEVentas(ByRef dt As DataTable, Tipo As Integer)
        If Tipo = 1 Then
            dt = L_fnObtenerCLientes(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
        Else
            dt = L_fnObtenerCLientesXCiudad(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbCiudad.Value)
        End If
        For i As Integer = 0 To dt.Rows.Count - 1 Step 1
            ...
            For k As Integer = mesInicial To mesFinal Step 1
                ...
                Else
                    ...
                    Else
                        fechaInicialMes = DateSerial(Year(tbFechaI.Value), k, 1)
    ...
    Sub _prCargarTableZONASVentas(ByRef dt As DataTable, Tipo As Integer)
        If Tipo = 1 Then
            dt = L_fnObtenerZonasVentasEstadistico(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
        Else
            dt = L_fnObtenerZonasVentasEstadisticoXCiudad(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbCiudad.Value)
        End If
        For i As Integer = 0 To dt.Rows.Count - 1 Step 1
    ...
    End Sub
    Sub _prCargarTablePRODUCTOSVentas(ByRef dt As DataTable, Tipo As Integer)
        If Tipo = 1 Then
            dt = L_fnObtenerProductosVentasEstadistico(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
        Else
            dt = L_fnObtenerProductosVentasEstadisticoXCiudad(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbCiudad.Value)
        End If
        ...
        For i As Integer = 0 To dt.Rows.Count - 1 Step 1
            ...
            For k As Integer = mesInicial To mesFinal Step 1
                ...
                If Tipo = 1 Then
                    aux = L_fnObtenerVentasProductosEstadistico(fechaInicialMes.ToString("yyyy/MM/dd"), FechaFinalMes.ToString("yyyy/MM/dd"), numi)
                Else
                    aux = L_fnObtenerVentasProductosEstadisticoXCiudad(fechaInicialMes.ToString("yyyy/MM/dd"), FechaFinalMes.ToString("yyyy/MM/dd"), numi, cbCiudad.Value)
                End If
    ...
    End Sub
    Sub _prCargarTableVendedorVentas(ByRef dt As DataTable, Tipo As Integer)
        If Tipo = 1 Then
            dt = L_fnObtenerVendedores(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
        Else
            dt = L_fnObtenerVendedoresXCiudad(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbCiudad.Value)
        End If
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        If (cbConcepto.Value = 1) Then
            If swCiudad.Value = True Then
                _prCargarTableVendedorVentas(_dt, 1)
            Else
                _prCargarTableVendedorVentas(_dt, 2)
            End If

        End If
        If (cbConcepto.Value = 2) Then
            If swCiudad.Value = True Then
                _prCargarTableCLIENTEVentas(_dt, 1)
            Else
                _prCargarTableCLIENTEVentas(_dt, 2)
            End If
        End If
        If (cbConcepto.Value = 3) Then
            If swCiudad.Value = True Then
                _prCargarTablePRODUCTOSVentas(_dt, 1)
            Else
                _prCargarTablePRODUCTOSVentas(_dt, 2)
            End If
        End If
        If (cbConcepto.Value = 4) Then
            If swCiudad.Value = True Then
                _prCargarTableZONASVentas(_dt, 1)
            Else
                _prCargarTableZONASVentas(_dt, 2)
            End If
        End If
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            objrep.SetParameterValue("Ciudad", IIf(swCiudad.Value = True, "TODOS", cbCiudad.Text.ToUpper()))
    ...
    Private Sub swCiudad_ValueChanged(sender As Object, e As EventArgs) Handles swCiudad.ValueChanged
        cbCiudad.Enabled = IIf(swCiudad.Value = True, False, True)
    End Sub
End Class
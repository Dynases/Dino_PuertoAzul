        ...
        If (cbAlmacen.SelectedIndex >= 0) Then
            ...
            For j As Integer = 0 To productos.Rows.Count - 1 Step 1
                ...
                For i As Integer = 0 To result.Length - 1 Step 1
                    ...
                    If IsDBNull(result(i).Item("yhprecio")) Then
                        result(i).Item("yhprecio") = 0
                    End If
...
#End Region
    ...
    Private Sub grprecio_KeyPress(sender As Object, e As KeyPressEventArgs) Handles grprecio.KeyPress

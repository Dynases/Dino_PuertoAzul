...
#Region "VENTAS ESTADISTICOS"
    ...
    Public Shared Function L_fnObtenerVentasCOBRANZASEstadistico(_fechaI As String, _fechaF As String, _numiVendedor As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerVendedoresXCiudad(_fechaI As String, _fechaF As String, _Ciudad As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 11))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _fechaF))
        _listParam.Add(New Datos.DParametro("@ciudad", _Ciudad))
        _listParam.Add(New Datos.DParametro("@yduact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_VentasEstadisticos", _listParam)
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerCLientesXCiudad(_fechaI As String, _fechaF As String, _Ciudad As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerProductosVentasEstadisticoXCiudad(_fechaI As String, _fechaF As String, _Ciudad As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerZonasVentasEstadisticoXCiudad(_fechaI As String, _fechaF As String, _Ciudad As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerVentasProductosEstadisticoXCiudad(_fechaI As String, _fechaF As String, _numiProducto As Integer, _idCiudad As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@fechaF", _fechaF))
        _listParam.Add(New Datos.DParametro("@producto", _numiProducto))
        _listParam.Add(New Datos.DParametro("@ciudad", _idCiudad))
        _listParam.Add(New Datos.DParametro("@yduact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_VentasEstadisticos", _listParam)
